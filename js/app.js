...
firstapp.config(
  function($routeProvider, uiSelectConfig) {
    ...
    when('/user', {templateUrl: 'views/template.html',controller: 'UserCtrl'}).when('/createuser', {templateUrl: 'views/template.html',controller: 'createUserCtrl'}).when('/edituser/:id', {templateUrl: 'views/template.html',controller: 'editUserCtrl'}).when('/slider', {templateUrl: 'views/template.html',controller: 'SliderCtrl'}).when('/createslider', {templateUrl: 'views/template.html',controller: 'createSliderCtrl'}).when('/editslider/:id', {templateUrl: 'views/template.html',controller: 'editSliderCtrl'}).when('/config', {templateUrl: 'views/template.html',controller: 'ConfigCtrl'}).when('/createconfig', {templateUrl: 'views/template.html',controller: 'createConfigCtrl'}).when('/editconfig/:id', {templateUrl: 'views/template.html',controller: 'editConfigCtrl'}).when('/historicdata', {templateUrl: 'views/template.html',controller: 'HistoricDataCtrl'}).when('/createhistoricdata', {templateUrl: 'views/template.html',controller: 'createHistoricDataCtrl'}).when('/edithistoricdata/:id', {templateUrl: 'views/template.html',controller: 'editHistoricDataCtrl'}).when('/article', {templateUrl: 'views/template.html',controller: 'ArticleCtrl'}).when('/createarticle', {templateUrl: 'views/template.html',controller: 'createArticleCtrl'}).when('/editarticle/:id', {templateUrl: 'views/template.html',controller: 'editArticleCtrl'}).//Add New Path
